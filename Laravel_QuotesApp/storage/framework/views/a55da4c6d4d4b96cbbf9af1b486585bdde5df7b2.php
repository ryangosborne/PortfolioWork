                ...
                <div class="card">
                    ...
                    <form action="/post" method="POST" class="pb-3">
                        ...
                        <div class="form-group col-md mt-3">
                            ...
                            <input name="title" type="text" value="<?php echo e(old('title')); ?>" class="form-control" id="title" aria-describedby="titleHelp">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md">
                            ...
                            <input type="text" name="quote" class="form-control" id="quote" value="<?php echo e(old('quote')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ryan/Documents/Programming/INET2005 PHP/laravel/finalassignment-ryangosborne/SMFeed-w0201814/resources/views/post/create.blade.php ENDPATH**/ ?>