        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="/admin/themes/<?php echo e($theme->id); ?>" method="POST" class="pb-3">
                        ...
                        <div class="form-group col-md mt-3">
                            ...
                            <input name="name" type="text" value="<?php echo e(old('name', $theme->name)); ?>" class="form-control" id="name" aria-describedby="nameHelp">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md">
                            ...
                            <input type="url" name="themeLink" class="form-control" id="themeLink" value="<?php echo e(old('themeLink', $theme->cdn_url)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ryan/Documents/Programming/INET2005 PHP/laravel/finalassignment-ryangosborne/SMFeed-w0201814/resources/views/theme/edit.blade.php ENDPATH**/ ?>